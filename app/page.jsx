            ...
            <div className="relative py-12 sm:py-16 lg:py-20">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4 bg-white p-2 sm:p-3 rounded-lg shadow-md flex items-center gap-2 w-40 sm:w-48">
                    <div className="flex-col items-center gap-1">
                    <p className="text-xs sm:text-sm text-gray-600">
                      Satisfied Customer
                    </p>
                    <div className="flex items-center ">
                      <Star className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400 fill-yellow-400 mr-2" />
                  ...
                  <div className="absolute bottom-4 left-4 bg-white p-2 sm:p-3 rounded-lg shadow-md flex items-center gap-2 w-48 sm:w-56">
                  ...
                  <div className="absolute bottom-4 right-4 bg-white p-2 sm:p-3 rounded-lg shadow-md flex items-center gap-2">
